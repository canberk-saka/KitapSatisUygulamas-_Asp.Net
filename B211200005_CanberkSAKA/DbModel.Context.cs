...
namespace B211200005_CanberkSAKA
{
    ...
    public partial class KITAPSATISEntities : DbContext
    {
        public KITAPSATISEntities()
            : base("name=KITAPSATISEntities")
        {
        }
        ...
        public virtual DbSet<KitapAciklamalari> KitapAciklamalari { get; set; }
        public virtual DbSet<Kitaplar> Kitaplar { get; set; }
        public virtual DbSet<KitapYazarIliskisi> KitapYazarIliskisi { get; set; }
        public virtual DbSet<KitapYildizlari> KitapYildizlari { get; set; }
